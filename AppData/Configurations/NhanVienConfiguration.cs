...
namespace AppData.Configurations
{
    internal class NhanVienConfiguration : IEntityTypeConfiguration<NhanVien>
    {
        public void Configure(EntityTypeBuilder<NhanVien> builder)
        {
            ...
            builder.HasData(new NhanVien() { ID = new Guid("2EC27AB7-5F67-4ED5-AE67-52F9C9726EBF"), Ten = "Admin", Email = "bena@gmail.com", SDT = "0987654321", DiaChi = "Ha Noi", TrangThai = 1, IDVaiTro = new Guid("B4996B2D-A343-434B-BFE9-09F8EFBB3852"), PassWord = "$2a$12$wQ8TmEzFP4Dom4.h50er/O7GH7j32ehD8UBSqhhaWY67YnaTBJVmC" });//123456 pass
        }
    }
}
